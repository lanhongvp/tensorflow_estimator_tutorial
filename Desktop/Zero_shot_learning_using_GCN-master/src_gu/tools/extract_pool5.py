...
def init(model_path, sess):
    ...
    for v in my_var_list:
        name = v.name.split(':')[0]
        my_dict[name] = 0
        if name not in var_keep_dic.keys():
...
def parse_arg():
    ...
    parser.add_argument('--model_path', type=str, default='../../data/pretrain_weight/resnet_v1_50.ckpt',
                        help='path to pretrained model')
    parser.add_argument('--image_file', type=str, default='../../data/DatasetA_train_20180813/DatasetA_train_20180813/train.txt',
                        help='list of image file')
    parser.add_argument('--image_dir', type=str, default='../../data/DatasetA_train_20180813/DatasetA_train_20180813/train/',
